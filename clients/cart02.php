...
<head>
    ...
    <script>
        function endOrder(id){     // Validate an existing email in the DB using AJAX.
            $.ajax({
                url         : 'end_order.php',
                type        : 'post',
                dataType    : 'text',
...
<?php
    ...
    echo "<body>
            ...
            <nav class='navegacion'>
                ...
                <a class='navegacion__enlace navegacion__enlace--activo' href='cart01.php'>Carrito</a>
            </nav>
    ...
    if ($emptyRow == 0){    // If the cart is empty...
        ...
        echo "<div class='grid'>
            <div><table border='1'>
                <tr>
                    <th colspan='4'><h1>Tus productos en carrito</h1></th>
                <tr>
        ...
        echo "<tr>
                ...
                <tr>
                <td colspan='3'></td>
                <td colspan='1'><a class='navegacion__enlace boton__final' href='javascript:endOrder($id_order)'>Finalizar</a></td>
                </tr>
            </table></div>";
    }
