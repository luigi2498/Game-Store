...
<?php
    ...
    $con = connect();
    $sql = "SELECT * FROM admins WHERE status = 1 AND deleted = 0";
    $res = $con -> query($sql);
    ...
    echo "<body><div><h3>Crear nuevo administrador: </h3><a class='boton principal' href=\"admins_add.php\" class='boton_agregar'>AGREGAR</a><br><br>";

    echo "<table border='1'>
            <tr>
                <th colspan='7'><h2>Listado de administradores</h2></th>
            <tr>
                <td>ID</td>
                <td>Nombre</td>
                <td>Correo</td>
    ...
    while($row = $res -> fetch_array()){
        ...
        echo "<tr id='row$id'>
                ...
                <td><a class='boton ver' href=\"admins_details.php?id=$id\" class='boton_ver'>VER</a><br></td>
                <td><a class='boton editar' href=\"admins_edit.php?id=$id\" class='boton_editar'>EDITAR</a><br></td>
              </tr>";
    }
    echo "</table></body>";
?>